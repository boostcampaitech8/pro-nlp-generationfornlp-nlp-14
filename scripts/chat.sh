...
MODEL="/data/ephemeral/home/.cache/huggingface/hub/models--Qwen--Qwen3-32B-GGUF/snapshots/938a7432affaec9157f883a87164e2646ae17555/Qwen3-32B-Q6_K.gguf"
export MODEL
...
# 원하는 로그파일: 기본 server-chat.log
LOG="${LOG:-log/server-chat.log}"
PIDFILE="${PIDFILE:-log/llama-server-chat.pid}"
